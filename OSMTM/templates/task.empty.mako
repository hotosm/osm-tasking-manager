...
% else:
    <p>
    <a class="btn btn-primary" href="javascript:void(0);">Draw</a> the area of your choice on the map.
    </p>
    <span class="help-block">It can be as small as you want. You only need to ensure that you'll be able to map it in less than 2 hours</span>
% endif
