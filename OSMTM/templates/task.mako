        ...
        <div> 
            ...
            <form action="${request.route_url('task_done', job=tile.job_id, x=tile.x, y=tile.y, zoom=tile.zoom)}" class="form-horizontal">
                <div class="well">
                    ...
                    <div class="row">
                        <div class="span5">
                            <p>Links to <a href="${request.route_url('task_export', job=tile.job_id, x=tile.x, y=tile.y, zoom=tile.zoom, format='osm')}" target="_blank" rel="tooltip" data-original-title="Right-click on the link to save the file (JOSM) or copy its location (Potlatch)."> .osm</a> and <a href="${request.route_url('task_export', job=tile.job_id, x=tile.x, y=tile.y, zoom=tile.zoom, format='gpx')}" target="_blank" rel="tooltip" data-original-title="Right-click on the link to save the file (iD)."> .gpx</a> files.
                        </div>
                    </div>
                </div>
