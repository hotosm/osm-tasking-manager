...
def main(global_config, **settings):
    ...
    config.add_route('job_user', '/job/{job}/user/{user}', factory='OSMTM.resources.JobFactory')
    ...
    config.add_route('job_contributors', '/job/{job}/contributors', factory='OSMTM.resources.JobFactory')
