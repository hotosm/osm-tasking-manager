...
def main(global_config, **settings):
    ...
    config.add_route('task', '/job/{job}/task/{task}', factory='OSMTM.resources.JobFactory')
    config.add_route('task_unlock', '/job/{job}/task/{task}/unlock', factory='OSMTM.resources.JobFactory')
    config.add_route('task_done', '/job/{job}/task/{task}/done', factory='OSMTM.resources.JobFactory')
    config.add_route('task_take', '/job/{job}/task/{task}/take', factory='OSMTM.resources.JobFactory')
    config.add_route('task_create', '/job/{job}/task', factory='OSMTM.resources.JobFactory', request_method='POST')
    config.add_route('task_export', '/job/{job}/task/{task}/export.osm', factory='OSMTM.resources.JobFactory')
